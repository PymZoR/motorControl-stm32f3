...
C_SOURCES = \
  ...
  Src/main.c \
  Src/motionController.c \
  Src/stm32f3xx_hal_msp.c \
  Src/stm32f3xx_it.c \
  Src/motionControl/control.c \
  Src/motionControl/motors.c \
  Src/motionControl/PID.c \
  Src/peripherals/can.c \
  Src/peripherals/uart.c \
  Src/peripherals/encoders.c \
  Src/peripherals/gpio.c \
  Src/peripherals/pwm.c \
  Src/communcation/canProtocol.c \
  Src/communication/uartProtocol.c 
...
# macros for gcc
AS_DEFS =
C_DEFS = -D__weak="__attribute__((weak))" -D__packed="__attribute__((__packed__))" -DUSE_HAL_DRIVER -DSTM32F303x8
# includes for gcc
AS_INCLUDES =
...
C_INCLUDES += -IInc
C_INCLUDES += -IInc/motionControl
C_INCLUDES += -IInc/peripherals
# compile gcc flags
